...
function LoginPage() {
  ...
  const handleIdCheck = async () => {
    console.log('handleIdCheck 함수 시작'); // 함수 시작 로그
    console.log(`체크할 아이디: ${userId}`); // 체크할 userId 로그
    ...
    console.log(`아이디 사용 가능 여부: ${isAvailable}`); // 결과 로그
    ...
    console.log('handleIdCheck 함수 종료'); // 함수 종료 로그
  };
